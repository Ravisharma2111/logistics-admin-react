...
const Contant = () => {
  ...
  const fetchdata = async (value) => {
    ...
    await apiAdminConfig
      .get("api/auth/master/customer/search", {
        params: {
          search: value,
          per_page: pageSize,
          page: page,
              ...
              <Stack direction="row" justifyContent="space-between" mb={8}>
                ...
                <Box>
                  <Button
                    ...
                    onClick={() => {
                      navigate(`/master/customer/customers/add`);
                    }}
                  >
                    Add Customer
                  </Button>
                                        ...
                                        <Popover.Body>
                                          <Stack gap={2}>
                                            <Dropdown.Item
                                              onClick={() => {
                                                navigate(
                                                  `/master/customer/customers/view/${el.user_id}`
                                                );
                                              }}
                                            >
      ...
      : {
          ...
          padding: ".375rem .75rem",
                                            ...
                                            <Dropdown.Item
                                              onClick={() => {
                                                navigate(
                                                  `/master/customer/customers/edit/${el?.user_id}`
                                                );
                                              }}
                                            >
                                              <MdMode size={18} /> Edit
